...
# Get the current directory (__init__.py)
current_dir = os.path.dirname(os.path.abspath(__file__))
fakeStore_root = os.path.abspath(os.path.join(current_dir, "..", ".."))
metadata_path = os.path.join(fakeStore_root, "static", "uploads", "metadata.json")
